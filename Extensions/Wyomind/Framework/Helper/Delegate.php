 ...
 */
namespace Wyomind\Framework\Helper;  class Delegate extends \Wyomind\Framework\Helper\License {public $x8c398=null;public $xb0f23=null;public $x3f5b0=null; const VERSION = "\67\56\61.\62"; public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Framework\App\Helper\Context $context) { parent::__construct($objectManager, $context); $this->constructor($this, func_get_args(), __CLASS__); } protected function getDelegation() { ${$this->x8c398->xbe->x180} = "\\"; return [ ]; } }